...
inline auto SetupStorageDatabaseModels(const std::string& path)
{
    ...
    return make_storage(
        ...
        make_table(
            ...
            foreign_key(&ListData::board_id)
                .references(&BoardData::id)
                .on_delete.cascade()
        ),
        ...
        make_table(
            ...
            foreign_key(&CardData::list_id)
                .references(&ListData::id)
                .on_delete.cascade(),

            foreign_key(&CardData::board_id)
                .references(&BoardData::id)
                .on_delete.cascade()
        ),
        ...
        make_table(
            ...
            primary_key(&CardBadgeData::card_id,
                        &CardBadgeData::badge_id),

            foreign_key(&CardBadgeData::card_id)
                .references(&CardData::id)
                .on_delete.cascade(),

            foreign_key(&CardBadgeData::badge_id)
                .references(&BadgeData::id)
                .on_delete.cascade()
        ),
        ...
        make_table(
            "checklist_items",
            make_column("id", &ChecklistItemData::id,
                        primary_key().autoincrement()),
        ...
        make_table(
            ...
            foreign_key(&CommentData::card_id)
                .references(&CardData::id)
                .on_delete.cascade()
        )
    );
