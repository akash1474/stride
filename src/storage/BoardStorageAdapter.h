...
namespace Stride
{
    ...
    public:
         ...
         */
        static BoardData CreateBoard(const std::string& title, 
         ...
         */
        static CardList CreateList(const std::string& boardId,
         ...
         */
        static Card CreateCard(const std::string& listId,
                              const std::string& title,
                              const std::string& description,
                              double position);
         ...
         */
        static ChecklistItem CreateChecklistItem(const std::string& cardId,
                                                 const std::string& title,
                                                 bool isCompleted,
                                                 double position);
         ...
         */
        static std::string CreateBadge(const std::string& cardId,
        ...
        static Storage::ListData ToStorageList(const CardList& list, int boardId, double position);
        static Storage::CardData ToStorageCard(const Card& card, int listId, int boardId, double position);
        static Storage::ChecklistItemData ToStorageChecklistItem(const ChecklistItem& item, int cardId, double position);
    ...
    private:
        ...
        // Helper functions
        static double CalculatePosition(size_t index, size_t total);
